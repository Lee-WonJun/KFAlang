...
**구문:**
```
결과적으로는 제 안에 있는 <변수명>가 나오기 시작했습니다
```
...
**참고**
IF 식은 별도로 지원되지 않으며, While 루프를 활용하여 조건식을 대채합니다.
